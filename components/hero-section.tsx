    ...
    <section className="relative min-h-[88vh] flex items-center overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-4 py-28 relative z-10">
        <div className="max-w-2xl">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed animate-slide-up stagger-1">
            Interactive science and maths simulations that run right in your browser —
